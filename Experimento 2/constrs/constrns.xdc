...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {len_led}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {len_led}]
set_property PACKAGE_PIN E19 [get_ports {slow_led}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slow_led}]
...
##Sch name = JB7
#set_property PACKAGE_PIN A15 [get_ports {Blank}]					
